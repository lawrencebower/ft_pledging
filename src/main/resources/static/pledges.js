...
},{"./adapters/http":2,"./adapters/xhr":2,"./helpers/normalizeHeaderName":24,"./utils":27,"_process":33}],17:[function(require,module,exports){
'use strict';
...
const AllPledgesRefresher_1 = require("./AllPledgesRefresher");
window.onload = function (e) {
    new AllPledgesRefresher_1.AllPledgesRefresher().setup();
};

},{"./AllPledgesRefresher":31}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.AllPledgesRefresher = void 0;
const axios_1 = require("axios");
const JSEffects_1 = require("./JSEffects");
// const App: React.SFC = () => {}
class AllPledgesRefresher {
    constructor() {
        this.passedThreshold = false;
    }
    setup() {
        this.totalDiv = document.getElementById("total_div");
        this.pledgesDiv = document.getElementById("pledges_div");
        this.shortfallDiv = document.getElementById("shortfall_div");
        ...
        if (this.shortfallDiv != undefined) {
            ...
            if (ask > pledgeTotal) {
                ...
                if (!this.passedThreshold) {
                    // doFireworks();
                    // doRealistic();
                    new JSEffects_1.JSEffects().schoolPride();
...
exports.AllPledgesRefresher = AllPledgesRefresher;

},{"./JSEffects":32,"axios":1}],32:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.JSEffects = void 0;
...
class JSEffects {
    ...
    doRealFireworks() {
        let targetDiv = document.getElementById("outerDiv");
...
exports.JSEffects = JSEffects;

},{"canvas-confetti":28,"fireworks-js":29}],33:[function(require,module,exports){
